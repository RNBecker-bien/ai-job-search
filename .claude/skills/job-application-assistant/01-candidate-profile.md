...
- **Analytical Instrument Calibration** - *coursework*: Calibrated UV-Vis spectrometers, pH meters, and volumetric equipment following Good Laboratory Practices. Applied statistical quality control and Tukey outlier analysis to evaluate experimental data integrity.
...
- **Engineering Projects** - *coursework*: Developed COMSOL models for physiological airflow and hepatic blood flow simulations. Designed an Arduino-based patient communication interface featuring joystick navigation and LCD display.
