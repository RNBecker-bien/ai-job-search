...
- Verify both documents against `10-verification-checklist.md` before presenting them to the user
...
| `10-verification-checklist.md` | Mandatory pass/fail checklist for CV/cover letter accuracy, targeting, consistency, quality, compiled PDF, and ATS parseability |
