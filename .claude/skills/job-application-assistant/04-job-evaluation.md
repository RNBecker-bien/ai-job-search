...
- **17 applications now have final outcomes (12 rejected, 5 no_response); ~24 more are in_progress, the most advanced being Petal Surgical (phone-screen stage):**
...
- **Anduril - 2026 Early Career Electrical Engineer** (fit score 66/100, Good Fit, applied 2026-08-26): still open. Required test-equipment familiarity (oscilloscopes) matched the profile near-literally - the same literal tool/instrument-overlap signal that drove Petal Surgical's progress. Honest gaps disclosed: no Altium Designer/PCB design, no CAN/SPI/PCIe interface work, no embedded Linux development, no Rust/Haskell.
- **Anduril - 2026 Early Career Firmware Engineer** (fit score 57.9/100, Moderate Fit, applied 2026-08-28): still open. Genuine overlap on C-based embedded firmware, I2C/UART sensor integration, and oscilloscope debugging; RTOS/bare-metal, JTAG/SWD, and degree-field (Bioengineering vs. CS/CompE/Math/Physics) gaps disclosed honestly. Separate role/team from the Electrical Engineer application above.
- **Sector-pivot decision now in active execution (as of 2026-08-28):** the 2026-08-12 decision to stay open to adjacent high-tech sectors beyond biomedical is no longer just a scoring-framework note - it is producing real applications: Areté (Engineer 1, NPI Test - applied 2026-08-12), the two Anduril roles above, and Honeywell Aerospace (Systems Engineer I - posting saved, not yet applied). Illumina Systems Integration Engineer 1 (applied 2026-08-28, CV-only per that posting's no-generative-AI clause) is a third Illumina application this cycle, after two prior rejections on different Illumina roles.
